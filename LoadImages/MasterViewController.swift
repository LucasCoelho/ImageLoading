...
class MasterViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
  ...
  let objects = ["http://lh5.ggpht.com/_hepKlJWopDg/TB-_WXikaYI/AAAAAAAAElI/715k4NvBM4w/s144-c/IMG_0075.JPG",
  ...
  func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
    ...
    if let image = cell.mainImage?.dynamicType.sharedImageCache().cachedImageForRequest(url_request) {
